...
extern u16 Robot_ID;       // 机器人ID
extern u16 Cilent_ID;      // 客户端ID


/// @brief 删除操作
/// @param Del_Operate 图片指针
/// @param Del_Layer 图层数字
...
/*
   ...
   */
   framepoint=(unsigned char *)&del;
   HAL_UART_Transmit(&huart1,&framepoint,sizeof(del),0xffff);
   /*
...
/// @param image 图片指针
/// @param imagename 图片名称
/// @param Graph_Operate 图片操作
/// @param Graph_Layer 图层数字
/// @param Graph_Color 图片颜色
/// @param Graph_Width 线宽
/// @param Start_x 起始X
/// @param Start_y 起始Y
/// @param End_x 终止X
/// @param End_y 终止Y
...
/// @param imagename 图片名称
/// @param Graph_Operate 图片操作
/// @param Graph_Layer 图层数
/// @param Graph_Color 图片颜色
/// @param Graph_Width 线宽
/// @param Start_x 起始X
/// @param Start_y 起始Y
/// @param Graph_Radius 圆半径
...
/// @param Start_x 圆心x坐标
/// @param Start_y 圆心Y坐标
/// @param x_Length x方向轴长
/// @param y_Length y方向轴长
...
int Char_ReFresh(String_Data string_Data)
{
   ...
   UI_Data_Operate datahead;        //操作定义帧
...
float Float_ReFresh(Float_Data angle_Data)
{
   float i;
